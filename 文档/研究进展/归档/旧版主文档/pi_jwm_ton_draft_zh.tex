...
\bottomrule
\end{tabular}
\caption{Rollout-horizon 诊断。三行使用同一候选集合；quality audit 检查式 \eqref{eq:energy_balance}、式 \eqref{eq:paired_task_utility} 的可重建性、负能耗和动作注入有效性。结果来源为 \code{代码/artifacts/reports/pi\_jwm\_energy\_reward\_horizon\_study\_20260713/}。}
