...
def method_registry() -> dict[str, dict[str, Any]]:
    return {
        ...
        "independent_dual_gnn_residual": {
            ...
            "base_mode": "independent_dual_gnn",
        },
        "coupled_dual_gnn_residual": {
            "stage": "gpu_ready",
            "role": "pi_jwm_residual_main_model",
            "distribution_output": True,
            "graph_message_passing": True,
            "cross_graph_coupling": True,
            "residual_state_prediction": True,
        ...
        "coupled_directed_dynamic_v2": {
            ...
            "role": "directed_dynamic_structure_ablation",
            "distribution_output": True,
            "graph_message_passing": True,
            "cross_graph_coupling": True,
            "directed_message_passing": True,
            "dynamic_relation_rollout": True,
        ...
        "coupled_directed_dynamic_residual_v2": {
            "stage": "local_interface_ready",
            "role": "directed_dynamic_residual_candidate",
            "distribution_output": True,
            "graph_message_passing": True,
            "cross_graph_coupling": True,
            "directed_message_passing": True,
