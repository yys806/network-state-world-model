...
The output directory is D:/shen/网络组/文档/面试/src.  Every figure in this
script is derived from local JSON/CSV experiment artifacts; no conceptual
flowchart or AI-generated image is produced here.
"""
...
OUT_DIR = NETWORK_ROOT / "文档" / "面试" / "src"
