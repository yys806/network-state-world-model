...
| STEP 5.1B posterior/loss/metric primitives | `code/src/pi_jwm/step5_1b_posterior_loss_metric_v1.py`、`code/scripts/build_step5_1b_posterior_loss_metric_receipt_v1.py`、`code/artifacts/protocols/pi_jwm_step5_1b_posterior_loss_metric_v1_20260921/` | target-only encoders、posterior/prior separation、family MSE、raw/normalized bridge、masked analytic KL/free bits、L_Val、per-horizon metrics | CPU PRIMITIVES ACCEPTED；training loop/optimizer/GPU NOT STARTED |
