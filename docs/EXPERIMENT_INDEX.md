...
Step 3.1 最小样本构造也不属于训练实验：证据位于 `code/artifacts/protocols/pi_jwm_model_ready_sample_v1_20260919/`，覆盖 `H=2/L=2`、10 项合同检查、4 项 focused tests 和 round-trip；`locked_test=false`、training/gpu=false。
