...
| STEP 5.2 training loop | 05 §2 | `code/src/pi_jwm/step5_2_training_loop_v1.py`、`run_step5_2_training_loop_smoke_v1.py`、`STEP_05_2_TRAINING_LOOP_CURRICULUM_JOINT_TRAINING.md` | COMPLETE / FROZEN FOR CPU DEVELOPMENT TRAINING-LOOP INTEGRATION | STRUCTURAL_CHANGE | Stage 1 posterior warm-up、Stage 2 prior recursive `1→2` curriculum、KL warm-up/free bits、joint optimizer groups、prior-only validation、L_Val selector、checkpoint/resume；20/20 receipt checks | 仅 8/4 development bundle CPU smoke；full training/GPU/formal performance 未开始 | STEP 5.3 CPU Preflight |
