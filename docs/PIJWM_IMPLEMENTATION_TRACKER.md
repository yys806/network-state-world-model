...
| STEP 5.1D unified model-chain paired acceptance | 05 §1；4.3A/4.3B/4.4 | `build_step5_1d_unified_model_chain_v1.py`、`STEP_05_1D_UNIFIED_MODEL_CHAIN_PAIRED_ACCEPTANCE.md`、unified artifact | COMPLETE / CPU DEVELOPMENT ONLY | STRUCTURAL_CHANGE | 42/42 checks、12/12 pairing、actual prior/posterior/decoder、gradient 和 deterministic rebuild 已通过；模型仍 untrained | 研究者另行授权 STEP 5.2；不得自动执行 |
